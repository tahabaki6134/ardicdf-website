...
export function WorkCard({ work }: WorkCardProps) {
  return (
    <article className="group">
      <Link
        href={work.href}
        className="block rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-8 focus-visible:outline-bronze"
      >
        ...
        <p className="mt-5 text-sm font-semibold text-bronze">Explore this work →</p>
      </Link>
    </article>
  );
}
