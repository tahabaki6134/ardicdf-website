...
const projectIds = ["sculptural-reception-interior", "farmasi-boss-trip", "modular-artificial-rock-concert-environment", "cosmetic-bottle-display-props", "giant-burger-display-prop", "classical-decorative-columns", "ornamental-elephant-sculpture", "decorative-entrance-arch"];
