// Markets are separate from languages. No overseas office is implied.
export const targetCountries = ["DE", "FR", "GB", "NL", "BE", "CH", "AT", "IT", "ES", "PT", "IE", "DK", "SE", "NO", "IS", "PL", "MT", "MC", "RU", "QA", "AE", "SA", "KW", "BH"] as const;
